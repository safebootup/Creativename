...
def update(P1State):
        pygame.display.update(screen.blit(pygame.image.load((P1State)), (x,y)))
        pygame.display.update(pygame.draw.rect(screen, "RED", Hurt1))
        pygame.display.update(pygame.draw.rect(screen, "RED", Hurt2))
        pygame.display.update(pygame.draw.rect(screen, "GREEN", Health1))
        pygame.display.update(pygame.draw.rect(screen, "GREEN", Health2))
import pygame, sys
import Attacks
#Display
...
for i in range(2):
        ...
        while run and rounds == 0:
            ...
            if keys[pygame.K_a] and x > 0 and Lockout == False and JLock == False:
                x -= 10
                #pygame.display.update(screen.blit(pygame.image.load(("P1walk.png")), (x,y)))
                if keys[pygame.K_c]:
                    ...
                    pygame.display.update(screen.blit(pygame.transform.flip(Left, True, False), (x,y)))
                    pygame.display.update(pygame.draw.rect(screen, "RED", Hurt1))
                    pygame.display.update(pygame.draw.rect(screen, "RED", Hurt2))
                    pygame.display.update(pygame.draw.rect(screen, "GREEN", Health1))
                    pygame.display.update(pygame.draw.rect(screen, "GREEN", Health2))
                    #pygame.display.update(screen.blit(pygame.image.load(("P1Dir.png")), (x,y)))
            ...
            if keys[pygame.K_LEFT] and x2 > 0 and Lockout2 == False:
                    ...
                    if keys[pygame.K_m]:
                            ...
                            #pygame.draw.rect(screen, "GREEN", Health1)
                            #pygame.draw.rect(screen, "GREEN", Health2)
                            pygame.display.update(screen.blit(pygame.transform.flip(Left2, True, False), (x2,y2)))
            ...
            if keys[pygame.K_RIGHT] and x2 < 1500 - width and Lockout2 == False:
                    ...
                    if keys[pygame.K_m]:
                            ...
                            pygame.display.update(screen.blit(pygame.image.load(("P2Dir.png")), (x2,y2)))
            ...
            if keys[pygame.K_DOWN]:
                    ...
                    if keys[pygame.K_m]:
                            ...
                            pygame.display.update(screen.blit(pygame.image.load(("P2Crouttack.png")), (x2,y2)))
                            dmg = Attack.Atk("Down", x2,y2, Fighter1, x, y)
                            if dmg == True:
                                    Health1.w -= 10
                    pygame.display.update(screen.blit(pygame.image.load(("P2Crouch.png")), (x2,y2)))
            else:
                    Lockout2 = False
                    C2 = False
                    #Crouching = False
            ...
            if Crouching == False and jump == False  and keys[pygame.K_c] == False and C2 == False:
                ...
                #pygame.display.update(screen.blit(Stage, (0,0)))
                pygame.display.flip()
run = False
